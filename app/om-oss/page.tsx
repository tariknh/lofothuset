...
const Omoss = () => {
  return (
    <main className="w-full flex min-h-screen flex-col items-center justify-start">
      ...
      <section className="text-2xl gap-y-20 md:grid-cols-12 grid text-balance p-8  bg-white h-fit">
        <h2
          data-scroll
          data-scroll-speed=".1"
          className="sm:col-start-2 md:col-start-2 md:text-4xl lg:text-5xl sm:text-3xl col-span-full md:col-span-10  my-20"
        >
